...
//
//        //Create User
//        User seller = new User("Seller", "Prodovaikin", "ProdSeller", "12345678", "1234@mail.ru");
//        seller.setRanking(5);
...
//
//
//        User buyer = new User("Buyer", "Pokupaikin", "PokupBuyer", "87654321", "4321@mail.ru");
//        buyer.setRanking(1);
...
//                1000L,2018, 04, 20,
//                ItemState.STOCK, defaultCategory.hd);
//
//        buyer.addComment("Comment",Rating.LOW,"Орион");
//
//        Shipment shipment = new Shipment();
//        shipment.setBuyer(buyer);
//        shipment.setSeller(buyer);
...
//
//        User user = new User("Dmitry","Panteleev","Dimon","1234","1234@1234.ru");
//        user.setAdmin(true);
//        user.setRanking(10);
//
//
